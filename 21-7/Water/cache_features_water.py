"""
Cache frozen-encoder DINOv3 features for water bodies training.
"""
...
CACHE_ROOT = Path(r"C:\Users\13519\data\train\water_bodies\feature_cache")
...
def cache_split(split: str, model: DinoV3Vegetation, skip_empty=True):
    ds = WaterBodiesDataset(DATA_ROOT / split, normalize_mode="imagenet")
    ...
    print(f"\n[{split}] done: {cached_count}/{n} tiles cached to {out_dir} (skipped {n - cached_count} empty)")
